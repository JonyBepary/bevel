...
spec:
  ...
  values:
    ...
    vault:
      ...
      adminsecretprefix: {{ vault.secret_path | default('secretsv2') }}/data/{{ network.env.type }}{{ org.name | lower }}/peers/{{ peer_name }}-msp
      orderersecretprefix: {{ vault.secret_path | default('secretsv2') }}/data/localsupplychain/ca
